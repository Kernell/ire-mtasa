...
VertexShaderOutput VertexShaderFunction(VertexShaderInput input)
{
    ...
    output.Color 	= saturate( gLightDiffuse * DiffuseIntensity * dot( normal, gLightDirection );
...
float4 PixelShaderFunction(VertexShaderOutput input) : COLOR0
{
    ...
    return saturate( textureColor * input.Color + gLightAmbient * AmbientIntensity + specular );
}
