...
Android.UI.SystemColors	=
{
	...
	ControlText			= Android.UI.Color.FromArgb( 255, 255, 255, 255 );
	...
	BackColor3		= Android.UI.Color.FromArgb( 100, 40, 40, 40 );
	BackColor4		= Android.UI.Color.FromArgb( 42, 40, 40, 40 );
};