...
5 - Слот оружия 5 (Очки ночного виденья, инфакрасные очки, парашют)
]]
...
2. Если Вы нашли баг - сообщите о нём администратору. Использование багов игрового режима приравниватеся к использованию читов.
...
TEXT_PLAYER_NOT_LOGGED			= "Игрок не авторизирован"
...
TEXT_PLAYER_NAME_CHANGED2		= "Администратор %s сменил Вам ник %q на %q"
...
TEXT_PLAYER_SKIN_CHANGED		= "Администратор %s сменил Вам скин (Skin ID: %d Name: %q)"
TEXT_PLAYER_RECONNECTED			= "Отправлена команда на переподключение к серверу игроку %s (%d)"
TEXT_PLAYER_RECONNECTED_BY_ADMIN= "Администратор %s переподключил Вас к серверу"
...
TEXT_PLAYER_FACTION_CHANGED2	= "Администратор %s установил Вам фракцию %s (уровень прав: %s, ранк: %s (%d))"
TEXT_PLAYER_FACTION_REMOVED		= "Игрок %s (%d) теперь больше не состоит во фракции"
TEXT_PLAYER_FACTION_REMOVED2	= "Администратор %s выгнал Вас из фракции"
...
TEXT_INTERIORS_CREATION_FAIL	= "Ошибка: Неудалось получить индентификатор. Обратитесь к системному администратору"
TEXT_INTERIORS_REMOVE_SUCCESS	= "Интеньер '%s' (%d) успешно удалён"
TEXT_INTERIORS_TYPE_CHANGED		= "Тип интерьера '%s' (%d) успешено изменён на '%s'"
TEXT_INTERIORS_NAME_CHANGED		= "Название интерьера '%s' (%d) успешено изменено на '%s'"
TEXT_INTERIORS_PRICE_CHANGED	= "Цена интерьера '%s' (%d) успешено изменена на $%d"
TEXT_INTERIORS_BANK_CHANGED		= "Банк интерьера '%s' (%d) успешено изменён на $%d"
...
TEXT_INTERIORS_INT_CHANGED		= "Интеньер '%s' (%d) успешно изменён на '%s'"
TEXT_INTERIORS_OWNER_CHANGED	= "Владелец интерьера %q (%d) теперь %s"
TEXT_INTERIORS_FACTION_CHANGED	= "Интерьер %q (%d) теперь пренадлежит организации %q"
...
TEXT_VEHICLES_RESTORE_SUCCESS	= "Автомобиль %s (ID %d) успешно востановлен"
...
TEXT_VEHICLES_RESPAWN_CHANGED	= "Респавн автомобиля %s (ID %d) успешено изменён"
TEXT_VEHICLES_PLATE_CHANGED		= "Номер автомобиля %s (ID %d) успешено изменён на %s"
TEXT_VEHICLES_OWNER_CHANGED		= "Вы сделали %s (ID %d) владельцем автомобиля %s (ID %d)"
TEXT_VEHICLES_FACTION_CHANGED	= "Автомобиль %s (ID %d) теперь пренадлежит фракции %s"
TEXT_VEHICLES_JOB_CHANGED		= "Автомобиль %s (ID %d) теперь пренадлежит работе %s"
...
TEXT_VEHICLES_ACCESS_DENIED		= "Вы не можете удалять фиксированные автомобили"
...
TEXT_ITEMS_DOES_NOT_EXIST		= "Предмет который Вы пытаетесь передать - не сущестувет"
...
TEXT_EQUIPMENTS_FACTION_CHANGED		= "Арсенал ID %d теперь пренадлежит фракции %s (ID %d)"
