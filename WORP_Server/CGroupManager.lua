	...
	g_pDB:CreateTable( "uac_groups",
		{
			...
			{ Field = "rights",								Type = "TEXT",				Null = "YES",	Key = "",		Default = NULL };
		}
	);
--[[ 	
	...
	{ Field = "command.teleport:setfaction",		Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped",						Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:create",					Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:remove",					Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:setposition",			Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:setanimation",			Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:setfrozen",				Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:setdamageproof",			Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:setcollisions",			Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
	{ Field = "command.ped:toggle_labels",			Type = "enum('Yes','No')", 	Null = "NO", 	Key = "", 		Default = "No" };
...
function CGroupManager:Init()
	...
	local pResult = g_pDB:Query( "SELECT `id`, `name`, `caption`, `color`, `rights` FROM `uac_groups` ORDER BY `id` ASC" );
...
function CGroupManager:LoadGroup( iID, sName, sCaption, Color, sRights )
	local pGroup = CGroup( self, iID, sName, sCaption, Color );
	
	if sRights then
		for i = 1, sRights:len(), 8 do
			
		end
	end
	
	if Data then
		for sRightName, sValue in pairs( Data ) do
			local sRight = sRightName:split( '.' );
			
			if sRight[ 1 ] == 'general' then
				pGroup:AddRight( sRight[ 2 ], CGroupRight.RIGHT_TYPE_GENERAL, sValue == 'Yes' );
			elseif sRight[ 1 ] == 'command' then
				pGroup:AddRight( sRight[ 2 ], CGroupRight.RIGHT_TYPE_COMMAND, sValue == 'Yes' );
			end
		end
	end
end
