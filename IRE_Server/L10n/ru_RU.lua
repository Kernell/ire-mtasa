...
TEXT_UNK_ERROR					= "Попробуйте позже"
TEXT_REG_DISABLED				= "Регистрация временно отключена"
TEXT_REG_UNAVAILABLE 			= "Извините, регистрация в данный момент отключена";
TEXT_REG_MULTIACCOUNT			= "Вы уже регистрировались на этом сервере"
TEXT_REG_EMAIL_IN_USE			= "Данный e-mail уже используется"
TEXT_REG_EMAIL_IS_BLANK			= "Введите Ваш e-mail"
TEXT_REG_EMAIL_IS_SHORT			= "E-mail может быть не менее 3-х символов"
TEXT_REG_EMAIL_IS_LONG			= "E-mail может быть не более 64-х символов"
TEXT_REG_EMAIL_IS_INVALID		= "Неправильный формат e-mail"
TEXT_REG_PASSWORD_IS_BLANK		= "Введите пароль"
TEXT_REG_PASSWORD_IS_SHORT		= "Пароль может быть не менее 4-х символов"
TEXT_REG_PASSWORD_IS_LONG		= "Пароль может быть не более 64-х символов"
TEXT_REG_NICKNAME_IN_USE		= "Этот никнейм уже используется"
TEXT_REG_NICKNAME_IS_BLANK		= "Введите Ваш никнейм"
TEXT_REG_NICKNAME_IS_SHORT		= "Никнейм может быть не менее 3-х символов"
TEXT_REG_NICKNAME_IS_LONG		= "Никнейм может быть не более 64-х символов"
TEXT_REG_NICKNAME_IS_INVALID	= "Никнейм содержит запрещённые символы"
TEXT_REG_NICKNAME_IS_NUMBER		= "Никнейм не может состоять только из чисел"
TEXT_REG_REFER_NOT_FOUND		= "Пользователь с таким именем не найден"
TEXT_REG_REFER_IS_INVALID		= "Имя пользователя содержит запрещённые символы"
...
TEXT_NPC_ANIMATION_UPDATED		= "Анимация NPC ID %d успешно добавлена"
TEXT_NPC_ANIMATION_CLEARED		= "Все анимации для NPC ID %d успешно очищены"
