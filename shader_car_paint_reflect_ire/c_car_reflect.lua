...
Variables =
{
	renderDistance				= 50;		-- shader will be applied to textures nearer than this
	brightnessFactorPaint		= 0.081;
	brightnessFactorWShield		= 0.49;
	bumpSize 					= 0.02;		-- for car paint
	bumpSizeWnd 				= 0;		-- for windshields
	normal 						= 1.5;		-- the higher , the less normalised 0-2
	brightnessAdd 				= 0.5;		-- before bright pass
	brightnessMul 				= 1.5;		-- multiply after brightpass
	brightpassCutoff 			= 0.16;		-- 0-1
	brightpassPower 			= 2;		-- 1-5
	reflectionFlip 				= 1;		-- 0 or 1
	reflectionFlipAngle 		= 0.25;		-- -1,1
	dirtTexture 				= 1; 		-- 0 or 1
...
addEventHandler( "onClientResourceStart", getResourceRootElement( getThisResource()),
	function()
		...
		if not grunShader or not geneShader or not shatShader then
			...
			-- engineApplyShaderToWorldTexture ( grunShader, "WHEEL" )
